...
* A peça rainha no jogo xadrez pode movimentar um número ilimitado de casas nas linhas, colunas ou diagonais.
...
* Um exemplo da execução do programa é a resolução do problema com parâmetros:
...
* O Compilador __rextester__ permite executar o programa on-line no link:
